...
## github地址
[https://github.com/kuniseichi/converter](https://github.com/kuniseichi/converter)

## 安装
1. 直接下载可执行文件: [下载地址](https://github.com/kuniseichi/converter/releases)  
2. golang源码包: `go get github.com/kuniseichi/converter`
...
## 命令行用法
1. 下载对应平台的可执行文件, [下载地址](https://github.com/kuniseichi/converter/releases)
...
import (
	"fmt"
	"github.com/kuniseichi/converter"
)
func main() {
...
func main() {
	...
	err := t2t.
		...
		// 生成的结构体保存路径
		SavePath("/Users/fizz/go/src/github.com/kuniseichi/gupiao/model/model.go").
